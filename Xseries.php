...
?>
        ...
        <div class="row car-model">
          <div class="row">
            <div class="col-md-6">
              <img class="car-img" src="images/bmwx11.png">
            </div>
            <div class="car-details col-md-6">
             <div class="row text-details">BMW X 1</div>
             <!-- <div class="row text-details">Do not buy this crap</div>
			  ...
			  <a class="toggler text-details" href="X1.php" style="text-decoration:none;">Click to get more info</a>
            </div>
          </div>
        ...
        <div class="row car-model">
          <div class="row">
            <div class="col-md-6">
              <img class="car-img" src="images/bmwx31.png">
            </div>
            <div class="car-details col-md-6">
              <div class="row text-details">BMW X 3</div>
              <!--<div class="row text-details">Do not buy this crap</div>
              <div class="row text-details">Look into Tata Nano</div>
              <div class="row text-details">Fits your Budget,LOL</div>
              <span class="toggler text-details" id="200481163" onClick="gd(this.id)">Click to get more info</span>-->
			  <a class="toggler text-details" href="X3.php" style="text-decoration:none;">Click to get more info</a>
            </div>
          </div>
          <div class="row text-to-toggle">
        ...
        <div class="row car-model">
          <div class="row">
            <div class="col-md-6">
              <img class="car-img" src="images/bmwx61.png">
            </div>
            <div class="car-details col-md-6">
              <div class="row text-details">BMW X 6</div>
              <!--<div class="row text-details">Do not buy this crap</div>
              <div class="row text-details">Look into Tata Nano</div>
              <div class="row text-details">Fits your Budget,LOL</div>
              <span class="toggler text-details" id="200707505" onClick="gd(this.id)">Click to get more info</span>-->
			  <a class="toggler text-details" href="X6.php" style="text-decoration:none;">Click to get more info</a>
            </div>
          </div>
          <div class="row text-to-toggle">
