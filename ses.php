...
?>
	...
	<div class="image">
		<img src="images/ses.jpg"></img>
	</div>
	<div class="buybtn">
		<input type=button class="btn" onClick="location.href='buy.php'" value='BOOK NOW'>
	</div>
	<div class="over">
		<h2 class="gal">Sensuous And Innovative</h2>
		<p style="font-size:20px;">The Sesto Elemento is a masterpiece of extreme lightweight engineering and demonstrates the outstanding expertise of Automobili Lamborghini in all areas of carbon-fiber technology. Thanks to its sensational power-to-weight ratio of only 1.75 kilograms per hp, this very limited edition supersports car delivers unparalleled performance. From a standing start, the Sesto Elemento catapults itself to 100 km/h (62 mph) in a sensational 2.5 seconds. </p>
