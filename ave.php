...
?>
	...
	<div class="image">
		<img src="images/ave.jpg"></img>
	</div>
	<div class="buybtn">
		<input type=button class="btn" onClick="location.href='buy.php'" value='BOOK NOW'>
	</div>
	<div class="over">
		<h2 class="gal">A Relentless Force</h2>
		<p style="font-size:20px;">The Aventador is brutally powerful and obscenely flamboyant, but it's also surprisingly agile for its size, making it one of the most drivable Lambos ever produced. Simply because it's drivable doesn't make it easy to drive-and therein lies its appeal. Available as a coupe (or roadster), it flaunts a 6.5-liter, 691-hp V-12 mated to a seven-speed automatic transmission and all-wheel drive. For the ultimate, the Superveloce offers 740 hp. Get yours ASAP; only 600 will be sold worldwide. </p>
