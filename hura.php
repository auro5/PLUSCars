...
?>
	...
	<div class="image">
		<img src="images/hur.jpg"></img>
	</div>
	<div class="buybtn">
		<input type=button class="btn" onClick="location.href='buy.php'" value='BOOK NOW'>
	</div>
	<div class="over">
		<h2 class="gal">The Instinct Of The Future</h2>
		<p style="font-size:20px;">Nothing on Earth can you prepare you for the eyeball
			-melting performance of Lamborghini’s “entry-level” supercar, the Huracán.
			It hits 60 mph in 2.5 seconds; the estimated top speed is 202 mph. The 
			angular design is both severe and elegant; the stealth fighter–like 
			cockpit is as luxurious as it is intense. Nestled behind the cockpit is a 
			602-hp V-10 mated to a seven-speed dual-clutch automatic (sorry, no manual
			 transmission is offered) and all-wheel drive. A topless Spyder is also
			  available.</p>
