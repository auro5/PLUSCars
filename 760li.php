...
?>
   ...
   <img id="m3headimg" src="images/bmw760li.png" alt="logo"  />
   <input type=button class="repbtn" onClick="location.href='buy.php'" value='BOOK NOW'>
   <div class="over">

   <h1>The All New 2016 BMW 760Li</h1>
   <p>The standard features of the BMW 740 i include 3.0L I-6 315hp engine intercooled turbo, 8-speed automatic transmission with overdrive, 4-wheel anti-lock brakes (ABS), integrated navigation system, side seat mounted airbags, curtain 1st and 2nd row overhead airbags, driver and passenger knee airbag, airbag occupancy sensor, automatic air conditioning, 18" aluminum wheels, cruise control, ABS and driveline traction control.</p>
